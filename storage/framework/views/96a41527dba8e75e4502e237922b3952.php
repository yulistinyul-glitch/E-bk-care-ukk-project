<?php $__env->startSection('title', 'Layanan - E-BK Care'); ?>
    ...
    <div class="container px-4" style="z-index: 2; position: relative;">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 ps-lg-5" data-aos="fade-left">
                ...
                <a href="<?php echo e(route('galeri')); ?>" class="btn btn-link p-0 mt-3 text-teal fw-bold text-decoration-none border-bottom border-teal">Lihat Galeri Kegiatan →</a>
            </div>
        </div>
    </div>
</section>
...
<section class="focus-areas section-padding">
    <div class="container px-4">
        ...
        <div class="row g-4">
            <?php $__empty_1 = true; $__currentLoopData = $semua_layanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="service-card-minimal" data-aos="fade-up">
                        ...
                        <button type="button" class="btn btn-link learn-more-link text-uppercase p-0 border-0 text-start" 
                                ...
                                data-layanan="<?php echo e($item->slug); ?>">
    ...
    <div class="container px-4">
        <div class="row g-5 align-items-start">
            ...
            <div class="col-lg-6">
                ...
                <a href="<?php echo e(route('home')); ?>" class="btn-label shadow-sm">
...
var loginModal = document.getElementById('loginModal');
    loginModal.addEventListener('show.bs.modal', function (event) {
        ...
        loginBtn.href = "<?php echo e(route('login')); ?>?layanan=" + layananSlug;
    });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\E-bk-care-ukk-project\resources\views/layanan.blade.php ENDPATH**/ ?>
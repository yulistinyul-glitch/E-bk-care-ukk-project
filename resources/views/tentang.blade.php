            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-10">
                    <div class="divider-line" data-aos="zoom-in" data-aos-delay="200">
                        <h1 class="font-serif-custom mb-3 text-uppercase" style="font-size: 2.8rem; font-weight: 700;">{{ $content->title ?? 'E-BK CARE' }}</h1>
                        <p class="fst-italic" style="color: #333; font-size: 1.3rem;">"{{ $content->tagline ?? 'Tagline belum diisi' }}"</p>
                        <p class="text-muted mb-4 px-lg-5">{{ $content->desc_1 ?? 'Deskripsi belum diisi.' }}</p>
                        <p class="text-muted px-lg-5">{{ $content->desc_2 ?? 'Deskripsi tambahan belum diisi.' }}</p>
                    </div>
                </div>
            </div>
        </div>

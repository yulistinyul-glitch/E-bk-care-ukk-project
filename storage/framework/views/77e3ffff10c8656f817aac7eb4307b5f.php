    ...
    <div class="row g-2 mb-5">
        <div class="col-lg-7">
            <div class="card border-0 rounded-4 overflow-hidden shadow-sm h-100 position-relative">
                <img src="<?php echo e($unggulan->image); ?>" class="w-100 featured-img">
                <div class="card-img-gradient">
                    <p class="small mb-1"><i class="bi bi-clock me-1"></i> <?php echo e($unggulan->date); ?></p>
            ...
            <div class="d-flex flex-column gap-3">
                ...
                <div class="card sidebar-card shadow-sm">
                    <div class="d-flex align-items-center gap-3">
                        <img src="<?php echo e($s->image); ?>" class="sidebar-img">
                        <div>
                            <h6 class="fw-bold mb-1 small"><?php echo e($s->title); ?></h6>
                            <p class="text-muted mb-2" style="font-size: 0.7rem;"><i class="bi bi-clock me-1"></i> <?php echo e($s->date); ?></p>
...
<div class="section-biru-soft">
    <div class="container">
        ...
        <div class="row g-4" id="article-grid">
            ...
            <div class="col-12 col-md-4 mb-4 article-item" data-category="<?php echo e($item->category_slug ?? 'tech'); ?>">
                <div class="card card-artikel-putih shadow">
                    <div class="img-container-center">
                        <img src="<?php echo e($item->image); ?>" class="img-centered">
                    </div>
                    ...
                    <div class="card-body d-flex flex-column pt-0">
                        ...
                        <div class="footer-card-custom d-flex justify-content-between align-items-center">
                            <div class="author-info">
                                ...
                                <span><?php echo e($item->penulis); ?></span>
                            </div>

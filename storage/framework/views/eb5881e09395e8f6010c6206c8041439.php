    ...
    <div class="card h-100"
        ...
        <div class="card-body p-4 d-flex flex-column text-start">
            ...
            <div class="d-grid text-center mb-2"
                ...
                <?php $__currentLoopData = ['Min','Sen','Sel','Rab','Kam','Jum','Sab']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="small fw-bold text-dark opacity-50"
                         style="font-size: 11px;"><?php echo e($d); ?></div>
            ...
            <div class="d-grid text-center"
                ...
                <?php for($i=1; $i<=28; $i++): ?>
                    <div onclick="updateSchedule(<?php echo e($i); ?>)"
                         id="date-<?php echo e($i); ?>"
                         class="calendar-day <?php echo e($i == 24 ? 'active-date' : ''); ?>"
...
<?php echo $__env->make('gurubk.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\E-bk-care-ukk-project\resources\views/gurubk/dashboard.blade.php ENDPATH**/ ?>
  ...
  <aside id="sidebar-container" 
    ...
    <nav id="nav-content" 
        ...
        <div class="group relative flex items-center justify-center">
            <a href="/" class="p-3 rounded-full text-white hover:bg-white/20 transition-all">
        ...
        <div class="group relative flex items-center justify-center">
            <a href="/profile" class="p-3 rounded-full text-white hover:bg-white/20 transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">
        ...
        <div class="group relative flex items-center justify-center">
            <a href="/history" class="p-3 rounded-full text-white hover:bg-white/20 transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">

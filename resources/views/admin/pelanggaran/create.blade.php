...
<div class="container mt-4 d-flex justify-content-center">
    <div class="form-box w-100" style="max-width:600px; background:white; padding:35px; border-radius:25px; box-shadow:0 10px 30px rgba(0,0,0,0.08);">
        <h4 class="text-center" style="font-weight:600; color:#2D3436; margin-bottom:25px; font-size:1.4rem;">Tambah Data Pelanggaran</h4>
        ...
        <form action="{{ route('admin.pelanggaran.store') }}" method="POST">
            ...
            <div class="d-flex gap-3 mt-4">
                <a href="{{ route('admin.pelanggaran.index') }}" class="btn btn-secondary flex-fill" 
                   style="border-radius:12px; padding:12px; font-weight:500;">Batal</a>
                <button type="submit" class="btn btn-primary flex-fill" 
                    style="border-radius:12px; padding:12px; font-weight:500; background:#5D5FEF; border:none;">Simpan Data Pelanggaran</button>
            </div>
        </form>
    </div>
</div>

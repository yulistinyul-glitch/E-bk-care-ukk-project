  ...
  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
    ...
    <div class="flex flex-col gap-4">
      <div>
        ...
        <a href="<?php echo e(route('siswa.kotaksurat.index')); ?>" class="relative inline-block p-4 bg-white rounded-2xl border border-gray-100 shadow-sm hover:bg-gray-50 transition-all">
...
<div class="mx-5 mt-8 font-['Poppins']">
    <div class="flex justify-between items-center mb-3">
        ...
        <?php if($lastChat): ?>
      <a href="<?php echo e(route('siswa.chat', $lastChat->konseling_id)); ?>" class="text-blue-600 text-[10px] font-bold hover:underline tracking-widest">BUKA CHAT</a>
      <?php else: ?>
    ...
    <?php if($lastChat): ?>
    <a href="<?php echo e(route('siswa.chat', $lastChat->konseling_id)); ?>" class="flex items-center gap-4 bg-white p-4 rounded-3xl shadow-sm border border-gray-100 hover:bg-gray-50 transition-all active:scale-[0.98]">
        <div class="relative">
        ...
        <div class="flex-1 min-w-0">
            <div class="flex justify-between items-center">
                ...
                <p class="text-[8px] text-gray-400"><?php echo e($lastChat->created_at->diffForHumans()); ?></p>
            </div>

            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-10">
                    <div class="divider-line" data-aos="zoom-in" data-aos-delay="200">
                        <h1 class="font-serif-custom mb-3 text-uppercase" style="font-size: 2.8rem; font-weight: 700;"><?php echo e($content->title ?? 'E-BK CARE'); ?></h1>
                        <p class="fst-italic" style="color: #333; font-size: 1.3rem;">"<?php echo e($content->tagline ?? 'Tagline belum diisi'); ?>"</p>
                        <p class="text-muted mb-4 px-lg-5"><?php echo e($content->desc_1 ?? 'Deskripsi belum diisi.'); ?></p>
                        <p class="text-muted px-lg-5"><?php echo e($content->desc_2 ?? 'Deskripsi tambahan belum diisi.'); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container px-4 py-5">
        <div class="row text-center">
            <div class="col-md-4 service-box" data-aos="flip-up" data-aos-delay="100">
                ...
                <h4 class="service-title">COUNSELING</h4>
            ...
            <div class="col-md-4 service-box" data-aos="flip-up" data-aos-delay="200">
                ...
                <p class="service-subtitle">A Preventive Treatment</p>
                <div class="service-line"></div>
            </div>
            <div class="col-md-4 service-box" data-aos="flip-up" data-aos-delay="300">
                ...
                <h4 class="service-title">SELF MANAGEMENT</h4>
                <p class="service-subtitle">A Physical and Mental Health</p>
                <div class="service-line"></div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 px-0" data-aos="fade-left">
                <div class="overlap-box-blue overlap-right border-kuning-kanan shadow-lg">
                    <h2 class="font-serif-custom h4 mb-3 text-uppercase"><?php echo e($content->visi_judul ?? 'VISI KAMI'); ?></h2>
                    <p class="small fw-bold mb-3"><?php echo e($content->visi_tagline ?? 'Tagline visi belum diisi.'); ?></p>
                    <p class="text-description-muted mb-4"><?php echo e($content->visi_desc ?? 'Deskripsi visi belum diisi.'); ?></p>
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 px-0" data-aos="fade-right" style="position: relative; z-index: 20;">
                <div class="overlap-box-blue border-kuning-kiri shadow-lg overlap-left">
                    <h2 class="font-serif-custom h4 mb-3 text-uppercase"><?php echo e($content->misi_judul ?? 'MISI KAMI'); ?></h2>
                    <p class="small fw-bold mb-3"><?php echo e($content->misi_tagline ?? 'Tagline misi belum diisi.'); ?></p>
                    <p class="text-description-muted mb-4"><?php echo e($content->misi_desc ?? 'Deskripsi misi belum diisi.'); ?></p>

        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7">
                <div class="values-content">
                    ...
                    <a href="{{ route('tentang.index') }}" class="btn-read-more">Read More</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="stats-section">
    <div class="container px-4">
        {{-- <div class="stats-header">
            <h2>Statistik Dampak E-BK Care</h2>
            <p>Memberikan ruang aman bagi setiap siswa untuk tumbuh dan berkembang secara akademis maupun personal.</p>
        </div> --}}
    ...
    <section class="feedback-section">
        <div class="container px-4">
            ...
            <div class="feedback-footer-link">
                <a href="{{ route('kotaksaran') }}" class="btn-feedback-cta">Bantu Kami Berkembang, Kirim Feedback Anda &rarr;</a>
            </div>
        </div>
    </section>

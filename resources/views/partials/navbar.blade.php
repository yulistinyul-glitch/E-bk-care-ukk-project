<div class="fixed bottom-0 left-0 justify-center w-full z-50 bg-[#B1D0E0] rounded-t-4xl lg:hidden">
    <nav class="w-full flex justify-around items-center p-3">
        ...
        <a href="{{ route('siswa.home')}}" class="group flex items-center justify-center w-14 h-14 rounded-full transition-all duration-500 ease-in-out hover:w-40 hover:bg-[#1A374D] hover:text-white  overflow-hidden
        ...
        <a href="{{ route('siswa.profile')}}" class="group flex items-center justify-center w-14 h-14 rounded-full transition-all duration-500 ease-in-out hover:w-40 hover:bg-[#1A374C] hover:text-white overflow-hidden">
          <div class="flex justify center shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" class="fill-current text-[#1A374C] group-hover:text-white transition-colors duration-500">
  ...
  <aside id="sidebar-container" 
    ...
    <nav id="nav-content" 
        ...
        <div class="group relative flex items-center justify-center">
            <a href="{{ route('siswa.home')}}" class="p-3 rounded-full text-white hover:bg-white/20 transition-all">
        ...
        <div class="group relative flex items-center justify-center">
            <a href="{{ route('siswa.profile')}}" class="p-3 rounded-full text-white hover:bg-white/20 transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">
        ...
        <div class="group relative flex items-center justify-center">
            <a href="{{ route('siswa.history')}}" class="p-3 rounded-full text-white hover:bg-white/20 transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">

     ...
     <div class="bg-white w-full max-w-95 shadow-2xl rounded-4xl p-8 md:p-10">
        ...
        <div class="mb-8">
            ...
            <div id="form-siswa" class="space-y-4 transition-all duration-300">
                ...
                <form action="<?php echo e(route('siswa.login.submit')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-6 text-right">
                        <a href="<?php echo e(route('siswa.forgot-password')); ?>" class="text-xs text-[#1A374D] font-bold hover:underline">
                            Lupa Password?
                        </a>
                    </div>
            ...
            <div id="form-guru" class="hidden space-y-4 transition-all duration-300">
                <form action="<?php echo e(route('gurubk.login.submit')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\e-bk-care-venusvault\resources\views/auth/login.blade.php ENDPATH**/ ?>
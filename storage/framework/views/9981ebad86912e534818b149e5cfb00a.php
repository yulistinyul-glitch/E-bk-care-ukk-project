...
<body class="font-['Poppins'] min-h-screen flex items-center justify-center p-4"
    ...
    <div class="w-full mx-auto flex flex-col md:flex-row items-center md:gap-16 p-8 max-w-md md:max-w-4xl md:backdrop-blur-sm">
        ...
        <div class="bg-white p-8 w-full max-w-95 shadow-2xl items-center text-blue-950 rounded-3xl">
            <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST" autocomplete="off">
                <?php echo csrf_field(); ?>
                
                <?php if(session('error')): ?>
                    <div class="text-red-500 text-sm text-center bg-red-100 p-2 rounded-xl mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-4 py-3 rounded-xl border-2 border-gray-100 bg-gray-50 focus:border-[#1A374D] focus:outline-none transition-all text-sm">
                </div>

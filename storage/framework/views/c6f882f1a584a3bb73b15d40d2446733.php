            ...
            <form action="<?php echo e(route('admin.siswa.index')); ?>" method="GET">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col text-end">
                        <a href="<?php echo e(route('admin.siswa.cetak.semua')); ?>" class="btn-export-solid">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="table-select-display" disabled>
                                    <option><?php echo e($s->kelas->nama_lengkap ?? '-'); ?></option>
                                </select>
                            </td>
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-3">
                                    <a href="<?php echo e(route('admin.siswa.edit', $s->id_siswa)); ?>" class="btn-action-icon icon-edit">
                                         <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <button type="button" class="btn-action-icon icon-delete" onclick="hapusData('<?php echo e($s->id_siswa); ?>')">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                    <form id="delete-<?php echo e($s->id_siswa); ?>" action="<?php echo e(route('admin.siswa.destroy', $s->id_siswa)); ?>" method="POST" style="display:none;">

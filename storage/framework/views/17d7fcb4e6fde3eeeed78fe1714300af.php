        ...
        <div class="header-top">
            <div class="container px-4 position-relative">
                ...
                <div class="logo-placeholder">
                      <img src="<?php echo e(asset('img/logo_ebk-careGold.png')); ?>" alt="Logo" width="40" class="logo-img">
                </div>
                <a href="<?php echo e(route('login')); ?>" class="font-poppins login-btn">LOGIN</a>
...
<section class="card-slider-section" data-aos="fade-up">
    ...
    <div class="slider-wrapper" id="sliderContainer">
        ...
        <?php $__currentLoopData = $semua_artikel->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card-footer-box">
                <div class="author-group">
                    ...
                    <span class="author-name">
                        direct by <?php echo e($item->penulis ?? 'Admin'); ?> <?php echo e($item->created_at->format('Y')); ?>
...
<section class="feedback-section" data-aos="fade-up">
    ...
    <div class="feedback-footer-bar mt-5 font-poppins">
        <div class="container px-4">
            <a href="<?php echo e(route('kotaksaran')); ?>" class="cta-link">

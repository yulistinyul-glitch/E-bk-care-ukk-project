    ...
    <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="5000">
                ...
                <img src="<?php echo e(asset('img/hero1.jpg')); ?>" class="d-block w-100 vh-100 object-fit-cover">
            </div>
            <div class="carousel-item" data-bs-interval="5000">
                <div class="overlay"></div>
                <img src="<?php echo e(asset('img/hero2.jpg')); ?>" class="d-block w-100 vh-100 object-fit-cover">
            </div>
            <div class="carousel-item" data-bs-interval="5000">
                <div class="overlay"></div>
                <img src="<?php echo e(asset('img/hero4.jpg')); ?>" class="d-block w-100 vh-100 object-fit-cover">
            </div>
        </div>
...
</script><?php /**PATH C:\Users\lenovo\E-bk-care-ukk-project\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>
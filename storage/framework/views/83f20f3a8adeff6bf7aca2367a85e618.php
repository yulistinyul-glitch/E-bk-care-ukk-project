    ...
    <div class="w-full max-w-md md:max-w-4xl flex flex-col md:flex-row md:gap-16 items-center p-4 md:p-8 md:border-2 md:border-white/40 md:rounded-[40px] md:backdrop-blur-sm">
        ...
        <div class="text-center mb-5 md:mb-0 md:flex-1">
            ...
            <p class="text-white text-lg font-medium leading-tight px-10">
                please remember the password well
            </p>
        </div>

        <div class="bg-white w-full md:flex-1 p-8 md:p-10 rounded-[40px] shadow-2xl">
            <h2 class="text-center text-2xl font-bold text-black mb-10">Create new password</h2>
            <form action="<?php echo e(route('siswa.update-password')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-4">
                    <label for="email" class="block mb-2 font-bold text-gray-700 ">Email Aktif</label>
                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" required 
                        class="w-full p-3 rounded-xl border-2 border-black focus:outline-none focus:ring-2 focus:ring-blue-400" 
...
</html><?php /**PATH D:\e-bk-care-venusvault\resources\views/auth/new-pass.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'History Template Surat'); ?>
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 px-2">
        ...
        <div>
            <a href="<?php echo e(route('admin.template_surats.index')); ?>" class="btn-back">
                ...
                <table class="table text-center align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-light text-dark" style="font-size: 10px;"><?php echo e($t->jenis_template); ?></span></td>
                            <td><?php echo e($t->deleted_at->format('d M Y, H:i')); ?></td>
                            <td>
                                <div class="d-flex justify-content-center gap-3">
                                    
                                    <form action="<?php echo e(route('admin.template_surats.restore', $t->id_template)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <button type="button" class="btn-action-icon icon-delete-permanent" 
                                            ...
                                            onclick="confirmForceDelete('<?php echo e($t->id_template); ?>')">
                                        <i class="bi bi-trash-fill"></i>
                                    </button>

                                    <form id="force-delete-<?php echo e($t->id_template); ?>" 
                                          action="<?php echo e(route('admin.template_surats.forceDelete', $t->id_template)); ?>" 
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\E-bk-care-ukk-project\resources\views/admin/template_surats/history.blade.php ENDPATH**/ ?>
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-start mb-4 px-2">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('admin.template_surats.history')); ?>" class="btn-history">
        ...
        <div class="table-container">
            <div class="table-responsive">
                <table class="table text-center align-middle">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($templates->firstItem() + $index); ?></td>
                            <td class="fw-bold"><?php echo e($t->id_template); ?></td>
                            <td class="text-start"><?php echo e($t->nama_template); ?></td>
                            <td>
                                <span class="badge-jk <?php echo e($t->jenis_template == 'SP' ? 'badge-sp' : 'badge-umum'); ?>">
                                    <?php echo e($t->jenis_template); ?>

                                </span>
                            </td>
                            <td class="text-muted small">
                                <i class="bi bi-file-earmark-text"></i> <?php echo e(Str::limit($t->file, 15)); ?>

                            </td>
                            <td>
                                <div class="d-flex justify-content-center gap-3">
                                    <button type="button" class="btn-action-icon icon-edit" 
                                            data-bs-toggle="modal" data-bs-target="#modalEdit<?php echo e($t->id_template); ?>">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>

                                    <button type="button" class="btn-action-icon icon-delete" 
                                            onclick="hapusData('<?php echo e($t->id_template); ?>')">
                                        <i class="bi bi-trash"></i>
                                    </button>

                                    <form id="delete-<?php echo e($t->id_template); ?>" 
                                          action="<?php echo e(route('admin.template_surats.destroy', $t->id_template)); ?>" 
...
<div class="modal fade" id="modalCreate" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.template_surats.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="modalEdit<?php echo e($t->id_template); ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0 pt-4 px-4">
            ...
            <form action="<?php echo e(route('admin.template_surats.update', $t->id_template)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                <div class="modal-body px-4">
                    <div class="mb-3">
                        <label class="small fw-bold mb-1">Nama Template</label>
                        <input type="text" name="nama_template" class="input-modal" value="<?php echo e($t->nama_template); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="small fw-bold mb-1">Jenis Template</label>
                        <select name="jenis_template" class="input-modal" required>
                            <option value="SP" <?php echo e($t->jenis_template == 'SP' ? 'selected' : ''); ?>>SP</option>
                            <option value="UMUM" <?php echo e($t->jenis_template == 'UMUM' ? 'selected' : ''); ?>>UMUM</option>
                        </select>
                    </div>
                    <div class="mb-3">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\E-bk-care-ukk-project\resources\views/admin/template_surats/index.blade.php ENDPATH**/ ?>
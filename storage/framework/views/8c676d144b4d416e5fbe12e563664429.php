        ...
        <div class="card-body p-4 p-md-3 d-flex justify-content-between align-items-center">
            <div class="text-white text-start" style="z-index: 2; max-width: 60%;">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="<?php echo e(url('/')); ?>" target="_blank" class="btn btn-outline-light fw-bold small rounded-3 px-4 py-2 transition-all">
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div class="p-3 rounded-circle d-flex align-items-center justify-content-center" 
                         style="background: <?php echo e($ms['color']); ?>10; color: <?php echo e($ms['color']); ?>; width: 45px; height: 45px;">
                ...
                <h6 class="text-muted small fw-bold mb-1" style="letter-spacing: 0.5px;"><?php echo e($ms['label']); ?></h6>
                <h2 class="fw-bold m-0" style="color: #1a233a; letter-spacing: -1px;"><?php echo e($ms['val']); ?></h2>
            </div>
        </div>
    </div>
                    ...
                    <div class="row g-0 small" style="font-size: 11px;">
                        <?php for($i=1; $i<=28; $i++): ?>
                            <div class="col-1-7 p-1">
                                <div class="py-1 rounded-2 <?php echo e($i == 19 ? 'bg-primary text-white fw-bold shadow-sm' : ''); ?>" style="<?php echo e($i == 19 ? 'background: #1a233a !important;' : ''); ?>">
                                    <?php echo e($i); ?>

                                </div>
                            </div>
                            <?php if($i % 7 == 0): ?> </div><div class="row g-0 small" style="font-size: 11px;"> <?php endif; ?>
                        <?php endfor; ?>
                    </div>
                </div>
        ...
        <div class="activity-timeline">
            ...
            <div class="d-flex gap-3 mb-4 position-relative p-2 rounded-3 transition-all activity-item">
                ...
                <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" 
                     style="width: 35px; height: 35px; background: <?php echo e($n['color'] ?? '#1a233a'); ?>15; color: <?php echo e($n['color'] ?? '#1a233a'); ?>;">
                    <i class="feather-<?php echo e($n['icon']); ?>" style="font-size: 13px;"></i>
                </div>

                <div class="w-100 overflow-hidden">
                    <div class="d-flex justify-content-between align-items-start">
                        <p class="mb-0 small fw-bold text-dark text-truncate" style="max-width: 150px;"><?php echo e($n['msg']); ?></p>
                        <small class="text-muted flex-shrink-0" style="font-size: 9px;"><?php echo e($n['time']); ?></small>
                    </div>
                    <div class="d-flex justify-content-between">
                        <small class="text-muted" style="font-size: 10px;"><?php echo e($n['user']); ?></small>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\e-bk-care-venusvault\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
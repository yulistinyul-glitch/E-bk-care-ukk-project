...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Halo Bapak/Ibu <strong>{{ $surat->siswa->kelas->walikelas->nama_guru ?? 'Wali Kelas' }}</strong>,</p>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>: <strong>{{ $surat->siswa->nama_siswa }}</strong></td>
                </tr>
                <tr>
                    <td>NIPD</td>
                    <td>: {{ $surat->siswa->NIPD }}</td>
                </tr>
                <tr>
                    <td>Kelas</td>
                    <td>: {{ $surat->siswa->kelas->nama_lengkap }}</td>
                </tr>
                <tr>
                    <td>Nomor Surat</td>
                    <td>: {{ $surat->nomor_surat_resmi }}</td>
                </tr>
                <tr>
                    <td>Alasan</td>
